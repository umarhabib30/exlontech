...
<style>
    /* Team Section Gradient & Ambient Glow Background */
    .team-section {
        background: radial-gradient(ellipse 100% 60% at 50% 0%, rgba(135, 80, 247, 0.12) 0%, #f7f3ff 70%), linear-gradient(180deg, #f4f0fa 0%, #f7f3ff 100%);
    }
    ...
    .team-card {
        ...
        box-shadow: 0 10px 30px rgba(135, 80, 247, 0.15);
    }
    ...
    .team-swiper .swiper-pagination-bullet {
        background: rgba(135, 80, 247, 0.4) !important;
        opacity: 1 !important;
        width: 9px !important;
    ...
    .vision-glow {
        ...
        width: 500px;
        height: 500px;
        background: radial-gradient(circle, rgba(113,43,254,0.1) 0%, rgba(15,7,21,0) 70%);
        filter: blur(80px);
        pointer-events: none;
        z-index: 0;
    }
...
<div class="main-wrapper about-page">
    ...
    <section class="tw-py-32 tw-bg-[#f4f0fa] dark:tw-bg-[#0f0715] tw-relative tw-overflow-hidden">
        ...
        <div class="container">
            <div class="tw-text-center tw-mb-16 tw-relative tw-z-10 wow fadeInUp" data-wow-delay=".2s">
                ...
                <h2 class="tw-text-[clamp(2rem,4.5vw,3rem)] tw-font-extrabold tw-bg-gradient-to-r tw-from-[#8750f7] tw-to-[#2a1454] dark:tw-from-[#712bfe] dark:tw-to-[#e5d9fd] tw-bg-clip-text tw-text-transparent tw-m-0">The Three Exlon Tech Beliefs</h2>
            </div>
            ...
            <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-y-16 md:tw-gap-y-[60px] tw-gap-x-12 lg:tw-gap-x-20 tw-items-center tw-justify-items-center tw-w-full tw-mx-auto">
                ...
                <div class="tw-bg-white dark:tw-bg-[rgba(25,15,38,0.6)] tw-border tw-border-[#8c57f7]/20 dark:tw-border-[#8c57f7]/30 tw-rounded-2xl tw-p-[30px] tw-w-full tw-max-w-[440px] tw-transition-all tw-duration-300 hover:tw-border-[#8c57f7]/50 hover:tw--translate-y-1.5 tw-shadow-[0_4px_20px_rgba(135,80,247,0.08)] dark:tw-shadow-[0_10px_30px_rgba(135,80,247,0.1)] tw-relative tw-z-10 tw-flex tw-flex-col tw-items-start tw-mx-auto md:tw-mr-auto md:tw-ml-0 tw-order-1 md:tw-col-start-1 md:tw-row-start-1 wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <h3 class="tw-text-xl tw-font-bold tw-text-[#0f0715] dark:tw-text-white tw-mb-2">People First</h3>
                    <p class="tw-text-sm tw-leading-relaxed tw-text-[#554a65] dark:tw-text-[#a098b0] tw-m-0">We build with empathy — for our clients, learners, and team. Every solution starts with understanding real needs.</p>
                </div>
                ...
                <div class="tw-bg-white dark:tw-bg-[rgba(25,15,38,0.6)] tw-border tw-border-[#8c57f7]/20 dark:tw-border-[#8c57f7]/30 tw-rounded-2xl tw-p-[30px] tw-w-full tw-max-w-[440px] tw-transition-all tw-duration-300 hover:tw-border-[#8c57f7]/50 hover:tw--translate-y-1.5 tw-shadow-[0_4px_20px_rgba(135,80,247,0.08)] dark:tw-shadow-[0_10px_30px_rgba(135,80,247,0.1)] tw-relative tw-z-10 tw-flex tw-flex-col tw-items-start tw-mx-auto md:tw-ml-auto md:tw-mr-0 tw-order-3 md:tw-col-start-2 md:tw-row-start-2 wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <h3 class="tw-text-xl tw-font-bold tw-text-[#0f0715] dark:tw-text-white tw-mb-2">Purpose-Driven Tasks</h3>
                    <p class="tw-text-sm tw-leading-relaxed tw-text-[#554a65] dark:tw-text-[#a098b0] tw-m-0">Every project, course, and campaign is crafted with clarity, impact, and long-term value in mind — not just trends.</p>
                </div>
                ...
                <div class="tw-bg-white dark:tw-bg-[rgba(25,15,38,0.6)] tw-border tw-border-[#8c57f7]/20 dark:tw-border-[#8c57f7]/30 tw-rounded-2xl tw-p-[30px] tw-w-full tw-max-w-[440px] tw-transition-all tw-duration-300 hover:tw-border-[#8c57f7]/50 hover:tw--translate-y-1.5 tw-shadow-[0_4px_20px_rgba(135,80,247,0.08)] dark:tw-shadow-[0_10px_30px_rgba(135,80,247,0.1)] tw-relative tw-z-10 tw-flex tw-flex-col tw-items-start tw-mx-auto md:tw-mr-auto md:tw-ml-0 tw-order-5 md:tw-col-start-1 md:tw-row-start-3 wow fadeInUp" data-wow-delay=".3s">
                    <div class="tw-w-11 tw-h-11 tw-rounded-lg tw-bg-[#8750f7]/15 tw-flex tw-items-center tw-justify-center tw-text-[#8750f7] tw-mb-5 tw-flex-shrink-0">
                        <svg class="tw-w-6 tw-h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-1a2 2 0 10-4 0v1a1 1 0 01-1 1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z"/>
                        </svg>
                    </div>
                    <h3 class="tw-text-xl tw-font-bold tw-text-[#0f0715] dark:tw-text-white tw-mb-2">Collaboration Wins</h3>
                    <p class="tw-text-sm tw-leading-relaxed tw-text-[#554a65] dark:tw-text-[#a098b0] tw-m-0">We believe the best results come from shared ideas and open minds — we work with you, not just for you.</p>
                </div>
    ...
    <section class="team-section tw-py-24 sm:tw-py-32 tw-relative tw-overflow-hidden tw-w-full">
        ...
        <div class="tw-w-full tw-px-2 sm:tw-px-4 lg:tw-px-6 tw-relative tw-z-10">
            <div class="tw-text-center tw-mb-16 tw-relative tw-z-10 wow fadeInUp" data-wow-delay=".2s">
                <span class="tw-inline-flex tw-items-center tw-gap-2 tw-px-4 tw-py-1.5 tw-rounded-full tw-bg-[#8750f7]/10 tw-border tw-border-[#8750f7]/30 tw-text-[#8750f7] dark:tw-text-[#a77bf3] tw-text-sm tw-font-semibold tw-tracking-wide tw-mb-3 tw-shadow-[0_0_20px_rgba(135,80,247,0.15)]">
    ...
    <section class="tw-py-8 tw-bg-[#ffffff] dark:tw-bg-[#09050e] tw-border-y tw-border-[#8c57f7]/15">
        <div class="container">
            <div class="tw-grid tw-grid-cols-3 sm:tw-grid-cols-4 tw-gap-x-2 sm:tw-gap-8 tw-justify-items-center tw-items-center">
                <div class="tw-flex tw-items-center tw-gap-1.5 sm:tw-gap-3 tw-justify-center wow fadeInUp" data-wow-delay=".1s">
                    <span class="tw-text-xl sm:tw-text-4xl lg:tw-text-5xl tw-font-extrabold tw-text-[#8750f7] dark:tw-text-white tw-leading-none">10</span>
                    <div class="tw-text-[9px] sm:tw-text-xs lg:tw-text-sm tw-font-bold tw-text-[#0f0715] dark:tw-text-white tw-leading-tight">Team<br>Members</div>
                </div>
                <div class="tw-flex tw-items-center tw-gap-1.5 sm:tw-gap-3 tw-justify-center wow fadeInUp" data-wow-delay=".2s">
                    <span class="tw-text-xl sm:tw-text-4xl lg:tw-text-5xl tw-font-extrabold tw-text-[#8750f7] dark:tw-text-white tw-leading-none">50+</span>
                    <div class="tw-text-[9px] sm:tw-text-xs lg:tw-text-sm tw-font-bold tw-text-[#0f0715] dark:tw-text-white tw-leading-tight">Projects<br>Completed</div>
                </div>
                <div class="tw-hidden sm:tw-flex tw-items-center tw-gap-3 tw-justify-center wow fadeInUp" data-wow-delay=".3s">
                    <span class="tw-text-4xl lg:tw-text-5xl tw-font-extrabold tw-text-[#8750f7] dark:tw-text-white tw-leading-none">50</span>
                    <div class="tw-text-xs lg:tw-text-sm tw-font-bold tw-text-[#0f0715] dark:tw-text-white tw-leading-tight">Happy<br>Clients</div>
                </div>
                <div class="tw-flex tw-items-center tw-gap-1.5 sm:tw-gap-3 tw-justify-center wow fadeInUp" data-wow-delay=".4s">
                    <span class="tw-text-xl sm:tw-text-4xl lg:tw-text-5xl tw-font-extrabold tw-text-[#8750f7] dark:tw-text-white tw-leading-none">5</span>
                    <div class="tw-text-[9px] sm:tw-text-xs lg:tw-text-sm tw-font-bold tw-text-[#0f0715] dark:tw-text-white tw-leading-tight">Years of<br>Experience</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="tw-py-24 tw-bg-[#f7f3ff] dark:tw-bg-[#0f0715] tw-relative tw-overflow-hidden">
        ...
        <div class="container">
            <div class="tw-text-center tw-mb-16 tw-relative tw-z-10 wow fadeInUp" data-wow-delay=".2s">
                <h2 class="tw-text-[clamp(2.2rem,5vw,3rem)] tw-font-extrabold tw-text-[#0f0715] dark:tw-text-white tw-m-0">Why Choose Us?</h2>
            </div>

            <div class="tw-grid tw-grid-cols-1 lg:tw-grid-cols-2 tw-gap-8 tw-relative tw-z-10 tw-w-full tw-mx-auto">
                <div class="tw-bg-white dark:tw-bg-[#0f0715] tw-border tw-border-[#8c57f7]/20 tw-rounded-2xl tw-p-8 hover:tw-border-[#8c57f7]/50 hover:tw--translate-y-1.5 tw-transition-all tw-duration-300 tw-shadow-[0_4px_20px_rgba(135,80,247,0.06)] dark:tw-shadow-[0_10px_30px_rgba(135,80,247,0.1)] tw-flex tw-flex-col tw-gap-4 tw-items-start wow fadeInUp" data-wow-delay=".1s">
                    ...
                    <h3 class="tw-text-xl tw-font-bold tw-text-[#0f0715] dark:tw-text-white tw-m-0">Proven Track Record of Excellence</h3>
                    <p class="tw-text-sm tw-leading-relaxed tw-text-[#554a65] dark:tw-text-[#a098b0] tw-m-0">Our dedicated team consistently goes the extra mile to exceed expectations and ensure complete client satisfaction.</p>
                </div>
                ...
                <div class="tw-bg-white dark:tw-bg-[#0f0715] tw-border tw-border-[#8c57f7]/20 tw-rounded-2xl tw-p-8 hover:tw-border-[#8c57f7]/50 hover:tw--translate-y-1.5 tw-transition-all tw-duration-300 tw-shadow-[0_4px_20px_rgba(135,80,247,0.06)] dark:tw-shadow-[0_10px_30px_rgba(135,80,247,0.1)] tw-flex tw-flex-col tw-gap-4 tw-items-start wow fadeInUp" data-wow-delay=".2s">
                    ...
                    <h3 class="tw-text-xl tw-font-bold tw-text-[#0f0715] dark:tw-text-white tw-m-0">Global Presence</h3>
                    <p class="tw-text-sm tw-leading-relaxed tw-text-[#554a65] dark:tw-text-[#a098b0] tw-m-0">Our international footprint allows us to deliver digital excellence with the agility and responsiveness needed to support organizations in today's dynamic global market.</p>
                </div>
                ...
                <div class="tw-bg-white dark:tw-bg-[#0f0715] tw-border tw-border-[#8c57f7]/20 tw-rounded-2xl tw-p-8 hover:tw-border-[#8c57f7]/50 hover:tw--translate-y-1.5 tw-transition-all tw-duration-300 tw-shadow-[0_4px_20px_rgba(135,80,247,0.06)] dark:tw-shadow-[0_10px_30px_rgba(135,80,247,0.1)] tw-flex tw-flex-col tw-gap-4 tw-items-start wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <h3 class="tw-text-xl tw-font-bold tw-text-[#0f0715] dark:tw-text-white tw-m-0">Industry Specific Expertise</h3>
                    <p class="tw-text-sm tw-leading-relaxed tw-text-[#554a65] dark:tw-text-[#a098b0] tw-m-0">With deep knowledge of your industry's unique standards and requirements, we deliver exceptional results with efficiency and precision.</p>
                </div>
                ...
                <div class="tw-bg-white dark:tw-bg-[#0f0715] tw-border tw-border-[#8c57f7]/20 tw-rounded-2xl tw-p-8 hover:tw-border-[#8c57f7]/50 hover:tw--translate-y-1.5 tw-transition-all tw-duration-300 tw-shadow-[0_4px_20px_rgba(135,80,247,0.06)] dark:tw-shadow-[0_10px_30px_rgba(135,80,247,0.1)] tw-flex tw-flex-col tw-gap-4 tw-items-start wow fadeInUp" data-wow-delay=".4s">
                    ...
                    <h3 class="tw-text-xl tw-font-bold tw-text-[#0f0715] dark:tw-text-white tw-m-0">On-Time Delivery</h3>
                    <p class="tw-text-sm tw-leading-relaxed tw-text-[#554a65] dark:tw-text-[#a098b0] tw-m-0">We are committed to delivering the promised solutions within the agreed timeframe, without compromising on quality or accuracy.</p>
                </div>
                ...
                <div class="tw-bg-white dark:tw-bg-[#0f0715] tw-border tw-border-[#8c57f7]/20 tw-rounded-2xl tw-p-8 hover:tw-border-[#8c57f7]/50 hover:tw--translate-y-1.5 tw-transition-all tw-duration-300 tw-shadow-[0_4px_20px_rgba(135,80,247,0.06)] dark:tw-shadow-[0_10px_30px_rgba(135,80,247,0.1)] tw-flex tw-flex-col tw-gap-4 tw-items-start wow fadeInUp" data-wow-delay=".5s">
                    ...
                    <h3 class="tw-text-xl tw-font-bold tw-text-[#0f0715] dark:tw-text-white tw-m-0">Skilled Team</h3>
                    <p class="tw-text-sm tw-leading-relaxed tw-text-[#554a65] dark:tw-text-[#a098b0] tw-m-0">At Exlon Tech, our team of industry specialists and business professionals brings deep expertise, innovative thinking, and a strong commitment to success.</p>
                </div>
                ...
                <div class="tw-bg-white dark:tw-bg-[#0f0715] tw-border tw-border-[#8c57f7]/20 tw-rounded-2xl tw-p-8 hover:tw-border-[#8c57f7]/50 hover:tw--translate-y-1.5 tw-transition-all tw-duration-300 tw-shadow-[0_4px_20px_rgba(135,80,247,0.06)] dark:tw-shadow-[0_10px_30px_rgba(135,80,247,0.1)] tw-flex tw-flex-col tw-gap-4 tw-items-start wow fadeInUp" data-wow-delay=".6s">
                    ...
                    <h3 class="tw-text-xl tw-font-bold tw-text-[#0f0715] dark:tw-text-white tw-m-0">Premium Value</h3>
                    <p class="tw-text-sm tw-leading-relaxed tw-text-[#554a65] dark:tw-text-[#a098b0] tw-m-0">Through flexible hiring models—ranging from dedicated teams and fixed-price projects to hourly engagements—we offer tailored solutions that deliver exceptional value to our clients.</p>
                </div>
            </div>
        </div>
    </section>
